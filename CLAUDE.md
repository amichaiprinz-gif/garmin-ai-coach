...
**מה לעשות עם הפלט:** שלח את כל הטקסט שיוצא כהודעת ווטסאפ לעמיחי. אל תקצר, אל תשנה, שלח הכל.

---

## משימה 2 — שאלה על נתוני כושר

כשעמיחי שואל שאלה על הכושר שלו (ריצה, שינה, דופק, אימון, Body Battery, HRV, המלצה לאימון וכדומה):
...
**אם יצא טקסט** — שלח אותו כהודעת ווטסאפ לעמיחי.
...
**חשוב:** בכל אימון כוח — לפחות 3 תרגילי בטן (עמיחי רוצה להוריד כרס).
...
```
אם לא עובד — API key פג. ספר לעמיחי.

**שגיאת Supabase:**
בדוק חיבור אינטרנט. אם יש חיבור ועדיין לא עובד — ספר לעמיחי.
