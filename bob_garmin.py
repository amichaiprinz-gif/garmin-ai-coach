...
=== ציוד זמין ===
משקולת אחת של 7.5 ק"ג + מזרן + גומיית התנגדות.
תרגילי כוח אפשריים: שכיבות שמיכה, משיכת משקולת לגב (חד-ידית), כפיפות מרפק עם משקולת, לחיצת כתפיים עם משקולת, הרמות צד עם משקולת, סקוואט עם משקולת, לאנג', גשר ישבן, תרגילי בטן, תרגילי גומיה (פשיטת ירך, חטיפת ירך, כפיפת ברך עם גומיה).
אסור להציע: לחיצת חזה, משיכת פולי, דדליפט עם מוט, שכיבות שמיכה עם משקל נוסף.

=== מצב רפואי — שוק (יוני 2026) ===
עמיחי חש כאב חזק בשוק בריצה האחרונה. ספורתרפיסט המליץ:
- הפסקת ריצה לשבוע-שבועיים, חזרה הדרגתית
- ריצה אחת בשבוע לכל היותר, קצרה וקלה
- הליכות מותרות ורצויות
- תוכנית שיקום רגליים: סקוואט סטטי על קיר (3-4×30שנ), עליות תאומים רגל אחת (3×15), גשר אחורי (4×12), הליכת עקבים (3×60שנ)
- לחזק רגליים לפני שחוזרים לריצה מלאה
...
ימים קבועים (מצב שיקום שוק — אין ריצה): שבת=שיקום רגליים (תרגילי פיזיו) | ראשון=כוח חזה+כתפיים+בטן | שני=כוח גב+ביצפס+בטן | שלישי=הליכה | רביעי=שיקום רגליים (תרגילי פיזיו) | חמישי=בטן+ידיים | שישי=הליכה קלה
חשוב: אין ריצות ואין אינטרוולים עד שהשוק מחלים לחלוטין.
